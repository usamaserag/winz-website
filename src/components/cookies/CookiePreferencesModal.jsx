...
const CookiePreferencesModal = () => {
  ...
  if (typeof document === 'undefined' || !isPreferencesOpen) return null;
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className="relative flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-t-2xl bg-white shadow-2xl sm:rounded-2xl animate-modal-in"
      >
