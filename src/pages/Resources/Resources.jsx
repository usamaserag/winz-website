...
export default function Resources() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden bg-gray-50/50">
      {/* Hero Header */}
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-primary-900 to-gray-900 pt-28 pb-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <SectionBadge label="Winz Customs Knowledge Hub" />
          </motion.div>
          ...
          >
            Access our dynamically updated repository of EU customs clearance processes, documents, research keywords, and reference guidelines.
          </motion.p>
        </div>
      </section>
