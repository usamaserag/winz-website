      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-brand-500 font-bold tracking-wider uppercase text-sm mb-2">{t('services.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-gray-50 rounded-2xl p-8 hover:bg-white hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                <div className="w-16 h-16 bg-brand-50 text-brand-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  {service.icon}
                </div>
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            <div>
              ...
              <div className="text-brand-100 font-medium">Years Experience</div>
            </div>
            <div>
              <div className="text-5xl font-black mb-2">50k</div>
              <div className="text-brand-100 font-medium">Delivered Packages</div>
            </div>
            <div>
              <div className="text-5xl font-black mb-2">200</div>
              <div className="text-brand-100 font-medium">Countries Covered</div>
            </div>
            <div>
