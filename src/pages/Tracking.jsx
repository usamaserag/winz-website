  ...
  return (
    <div className="pt-24 pb-16 min-h-screen bg-gray-50 flex flex-col items-center">
      <div className="container mx-auto px-4 md:px-8 max-w-4xl w-full">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl shadow-primary-500/5 border border-gray-100">
          <div className="flex flex-col md:flex-row gap-4">
            <input 
              type="text" 
              placeholder="e.g. WNZ-123456789"
              className="flex-grow px-6 py-4 rounded-xl border-2 border-gray-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/20 outline-none text-lg transition-all"
            />
